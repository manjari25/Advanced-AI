...
tr = load(str);
% tr = load('Data/exam_data_linsep_train.dat');
% tr = load('Data/exam_data_nonlinsep_train.dat');
...
te = load(str);
% te = load('Data/exam_data_linsep_test.dat');
% te = load('Data/exam_data_nonlinsep_test.dat');
% Seperate out the input and target vectors
x = te(:,(1:size(te,2)-1));
t = te(:,size(te,2));
...
% Load data file
tr = load('Data/game_codedata_train_new.dat');
% Seperate out the input and target vectors
x = tr(:,1:16);
t = tr(:,17:20);
...
% Load data file
te = load('Data/game_codedata_test_new.dat');
% Seperate out the input and target vectors
x = te(:,1:16);
t = te(:,17:20);
%Testing
